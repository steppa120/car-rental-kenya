...
/**
 * ============================================================
 * M-Pesa Payment Page – Direct from Booking Details
 * with Breeze Glassmorphism
 * ============================================================
 */
    ...
    <style>
        * {
        ...
        body {
            ...
            min-height: 100vh;
            background: radial-gradient(ellipse at 20% 30%, #ff05ff, #35a33e, #224cca);
            display: flex;
            align-items: center;
        ...
        /* ----- BREEZE GLASSMORPHISM PARTICLES ----- */
        .breeze-container {
            position: fixed;
            top: 0;
            left: 0;
        ...
        .breeze-particle {
            ...
            animation: breeze linear infinite;
            pointer-events: none;
        }

        /* Organic wavy movement like a breeze */
        @keyframes breeze {
            0% {
        ...
        .breeze-particle.slow {
            animation-duration: 12s;
        }
        .breeze-particle.medium {
            animation-duration: 8s;
        }
        .breeze-particle.fast {
            animation-duration: 5s;
        }

        /* ----- MAIN GLASS CARD (mpesa-box) ----- */
        .mpesa-box {
            position: relative;
            z-index: 10;
            max-width: 480px;
            ...
            border-radius: 40px;
            padding: 2rem;
            box-shadow: 0 25px 50px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.12);
            text-align: center;
            border: 1px solid rgba(255, 255, 255, 0.25);
...
<!-- Breeze Glassmorphism Background -->
<div class="breeze-container" id="breezeContainer"></div>
...
<script>
    (function() {
        // Generate breeze glass particles – organic shapes moving like wind
        const breezeContainer = document.getElementById('breezeContainer');
        if (!breezeContainer) return;

        const PARTICLE_COUNT = 35;
        const shapes = ['circle', 'square', 'leaf']; // for variety, all will use same CSS but we can add slight variations
        for (let i = 0; i < PARTICLE_COUNT; i++) {
            const particle = document.createElement('div');
            particle.classList.add('breeze-particle');
            
            // Random size between 15px and 70px
            const size = Math.floor(Math.random() * 55 + 15);
            ...
            breezeContainer.appendChild(particle);
        }
    })();
</script>
</body>
